const receita = {
  nome: 'Simple Omelette Recipe',
  foto: 'image-omelette.jpeg',
  descricao: 'An easy and quick dish, perfect for any meal. This classic omelette combines beaten eggs cooked to perfection, optionally filled with your choice of cheese, vegetables, or meats.',
  tempo: {
  ...
  nutricao: {
    descricao: 'The table below shows nutritional values per serving without the additional fillings.',
    tabela: {
      calories: '277kcal',
      carbs : '0g',
      protein: '20g',
